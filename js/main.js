...
if (window.location.hash != undefined) {
    switch (window.location.hash) {
        ...
        case "#Aries":
            ...
            likesText = "Comfortable clothes, taking on leadership roles, physical challenges, individual sports";
            dislikesText = "Inactivity, delays, work that does not use one's talents";
            descriptionText = `
                <p>
        ...
        case "#Gemini":
            ...
            likesText = "Music, books, magazines, chats with nearly anyone, short trips around the town";
            dislikesText = "Being alone, being confined, repetition and routine";
            descriptionText = `
                <p>
        ...
        case "#Cancer":
            ...
            likesText = "Art, home-based hobbies, relaxing near or in water, helping loved ones, a good meal with friends";
            dislikesText = "Strangers, any criticism of Mom, revealing of personal life";
            descriptionText = `
                <p>
        ...
        case "#Leo":
            ...
            likesText = "Theater, taking holidays, being admired, expensive things, bright colors, fun with friends";
            dislikesText = "Being ignored, facing difficult reality, not being treated like a king or queen";
            descriptionText = `
                <p>
        ...
        case "#Virgo":
            ...
            likesText = "Animals, healthy food, books, nature, cleanliness";
            dislikesText = "Rudeness, asking for help, taking center stage";
            descriptionText = `
                <p>
        ...
        case "#Libra":
            ...
            likesText = "Harmony, gentleness, sharing with others, the outdoors";
            dislikesText = "Violence, injustice, loudmouths, conformity";
            descriptionText = `
                <p>
        ...
        case "#Scorpio":
            ...
            likesText = "Truth, facts, being right, longtime friends, teasing, a grand passion";
            dislikesText = "Dishonesty, revealing secrets, passive people";
            descriptionText = `
                <p>
        ...
        case "#Sagittarius":
            ...
            likesText = "Freedom, travel, philosophy, being outdoors";
            dislikesText = "Clingy people, being constrained, off-the-wall theories, details";
            descriptionText = `
                <p>
        ...
        case "#Capricorn":
            ...
            likesText = "Family, tradition, music, understated status, quality craftsmanship";
            dislikesText = "Almost everything at some point";
            descriptionText = `
                <p>
